<?php
    ...
    define( 'K_DB_NAME', 'janvaye117_fivee' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'janvaye117_fivee' );
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', 'fivee' );
    // 7.
    // MySQL hostname (it will usually be 'localhost' )
    define( 'K_DB_HOST', 'ohm-media.nl' );
    // 7b.
    ...
    define( 'K_EMAIL_TO', 'j.vandijk-af@student.fontys.nl' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'mailhost@janvandijk.me' );
